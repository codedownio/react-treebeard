    ...
    (0, _createClass3.default)(TreeNode, [{
        ...
        value: function renderDrawer(decorators, animations) {
            var _props4 = this.props,
                node = _props4.node,
                getExtraChildren = _props4.getExtraChildren;


            var extraChildren = getExtraChildren && getExtraChildren(node) || [];
            var toggled = !!extraChildren || node.toggled;
        ...
        value: function renderChildren(decorators) {
            ...
            var _props6 = this.props,
                ...
                getExtraChildren = _props6.getExtraChildren,
            ...
            return _react2.default.createElement(
                ...
                children.map(function (child, index) {
                    return _react2.default.createElement(TreeNode, (0, _extends3.default)({}, _this3._eventBubbles(), {
                ...
                extraChildren.map(function (child, index) {
                    return _react2.default.createElement(TreeNode, (0, _extends3.default)({}, _this3._eventBubbles(), {
                        animations: animations,
                        decorators: propDecorators,
...
TreeNode.propTypes = {
    ...
    getExtraChildren: _propTypes2.default.func
};
